...
import threading, string, inspect, copy, socket, xmlrpclib
...
class myNotification(bn.BinaryDataNotification):
	...
	def data_written(self, view, offset, length):
		...
		autocollect.data_written(view, offset,length)
		pass
	...
	def function_added(self, view, func):
		...
		autocollect.func_added(view, func)
		pass
	def function_removed(self, view, func):
		print("function_removed: ", func)
		autocollect.func_removed(view, func)
		pass
	def function_updated(self, view, func):
		# print("function_updated")
		autocollect.func_updated(view, func)
		pass
	def data_var_added(self, view, var):
		autocollect.data_var_added(view, var)
		print("var_added: ", var)
		pass
	def data_var_removed(self, view, var):
		autocollect.data_var_removed(view, var)
	...
	def type_defined(self, view, name, type):
		global type_flag
		autocollect.type_defined(view, str(name), type)
		print("type_defined: ", name, type)
		pass
	def type_undefined(self, view, name, type):
		global type_flag
		autocollect.type_undefined(view, str(name), type)
...
bn.PluginCommand.register("Binja Start/Stop XML Server", "Start/Stop XML Server.", server_start_stop)
